  ...
  return (
    <>
      <div className="static-slider-head banner2">
        <Container>
          <Row className="" style={{paddingTop: "120px"}}>
            {(!currentUseState.isConnected) ?
              <Col lg="8" md="8" className="align-self-center">
                ...
                <h4 className="subtitle font-light" style={{ color: "#000", backgroundColor: "RGB(255,255,255,0.8)", padding: "5px;" }}>
                  An organic collective of miners living on the blockchain
                  <br />
                </h4>
                <a
                  onClick={() => walletBridge1.showWeb3Modal()}
                  className="btn btn-success m-r-20 btn-md m-t-30 " style={{ backgroundColor: "#9b8549" }}
                >
                  Connect Wallet
                </a>
              ...
              <Col lg="8" md="8" className="align-self-center">
                <>
                  <>
                    <br />
                    <p className="connected" style={{ backgroundColor: "RGB(0,0,0,0.9)", padding: "25px", fontSize: "40px", lineHeight: "auto" }}>
                      ...
                      <br />
                      {process.env.contractSymbol} Power : <strong>{currentUseState.xmPower.contractBalance}</strong>
                    </p>
                    <a
                      onClick={() => walletBridge1.disconnect()}
                      className="btn btn-md m-t-30 btn-outline-light "
                      style={{ backgroundColor: "#9b8549" }}
                    >
                      Disconnect Wallet
                    </a>
                    <br />
